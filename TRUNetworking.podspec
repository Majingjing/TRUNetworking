...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chenhuitong/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chenhuitong' => '1419430265@qq.com' }
  s.source           = { :git => 'https://github.com/chenhuitong/TRUNetworking.git', :tag => s.version.to_s }
